                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-file">
                                                ...
                                                <?php if ($newImage): ?>
                                                    <img src="{{ $newImage->temporaryUrl() }}" alt="Carousel Image" class="img-fluid img-thumbnail mb-3" width="100">
                                                <?php else: ?>
                                                    <img src="{{ asset('assets/images/slideshow-banners/' . $image) }}" alt="Carousel Image" class="img-fluid img-thumbnail mb-3" width="100">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="input-group mb-3">

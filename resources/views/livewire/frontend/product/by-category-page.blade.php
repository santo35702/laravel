<div id="page-content">
    ...
    <div class="collection-header">
        <div class="collection-hero">
            <div class="collection-hero__image"><img class="blur-up lazyload" data-src="{{ asset('assets/images/cat-men.jpg') }}" src="{{ asset('assets/images/cat-men.jpg') }}" alt="{{ ('Category name') }}" title="{{ ('Category name') }}" /></div>
            <div class="collection-hero__title-wrapper">
                <h1 class="collection-hero__title page-width">All Products on <span class="text-warning">{{ $category->name }}</span></h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="filters-toolbar-wrapper">
                            <div class="row">
                                <div class="col-4 col-md-4 col-lg-4 filters-toolbar__item collection-view-as d-flex justify-content-start align-items-center">
                                    ...
                                    <a href="{{ route('products.list.by_category', $category->slug) }}" title="List View" class="change-view">

<div id="page-content">
    ...
    <div class="collection-header">
        <div class="collection-hero">
            <div class="collection-hero__image"><img data-src="{{ asset('assets/images/cat-women3.jpg') }}" src="{{ asset('assets/images/cat-women3.jpg') }}" alt="All Product List View" title="All Product List View" /></div>
            <div class="collection-hero__title-wrapper">
                <h1 class="collection-hero__title page-width"><span class="text-warning">{{ $category->name }}</span>'s Products List</h1></h1>
            </div>
        </div>
    </div>
                        ...
                        <div class="filters-toolbar-wrapper">
                            <div class="row">
                                <div class="col-4 col-md-4 col-lg-4 filters-toolbar__item collection-view-as d-flex justify-content-start align-items-center">
                                    <a href="{{ route('products.by_category', $category->slug) }}" title="Grid View" class="change-view">
                                    ...
                                    <div class="list-view-item__image-column">
                                        <div class="list-view-item__image-wrapper">
                                            ...
                                            <a href="{{ route('products.details', $key->slug) }}">
                                                <img class="list-view-item__image blur-up lazyload" data-src="{{ asset('assets/images/product-images/' . $key->image) }}" src="{{ asset('assets/images/product-images/' . $key->image) }}" alt="image"
                                                    title="{{ $key->title }}">
                                            </a>
                                            <!-- End Image -->
                                        </div>

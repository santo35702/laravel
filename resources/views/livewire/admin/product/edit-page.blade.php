                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title"><i class="far fa-edit"></i> Update Products Information <small class="ml-2"><b class="badge badge-danger mr-1">Note:</b> All <span class="text-danger fa-2x">*</span> marks must fill required.</small></h3>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-file h-100">
                                                ...
                                                <?php if ($newImage): ?>
                                                    <img src="{{ $newImage->temporaryUrl() }}" alt="Product Image" class="img-fluid img-thumbnail mt-3" width="100">
                                                <?php else: ?>
                                                    <img src="{{ asset('assets/images/product-images/' . $image) }}" alt="Product Image" class="img-fluid img-thumbnail mt-3" width="100">
                                                <?php endif; ?>
                                                @error('image')
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="custom-select @error('category') is-invalid @enderror" id="category" required wire:model="category">

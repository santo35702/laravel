        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                <div class="alert alert-success text-capitalize" role="alert">
                    <i class="icon anm anm-truck-l icon-large"></i> &nbsp;<strong class="text-uppercase">Congratulations!</strong> You've got free shipping!
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2" class="text-right"><a href="#" class="btn--link cart-update"><i class="fa fa-trash"></i> Remove All</a></td>
                            </tr>
                        </tfoot>
                    </table>

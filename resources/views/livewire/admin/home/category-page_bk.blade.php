                ...
                <div class="col-12">
                    <div class="card card-success card-outline shadow">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-sitemap"></i> New Arrival Categories List</h3>
                    ...
                    <form wire:submit.prevent="updateItem" enctype="multipart/form-data">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-sitemap"></i> Arrivals Information</h3>
                                <div class="card-tools">
                                    <a href="{{ route('admin.dashboard') }}" class="btn btn-tool"><i class="fas fa-home"></i></a>
                                    <button type="button" class="btn btn-tool" data-card-widget="maximize" title="Expand">
                                        <i class="fas fa-expand"></i>
                                    </button>
                                </div>
